    ...
    <div class="sm:mt-16">
        ...
        ========================================================== --}}
            <section class="stats-section stats-overview">
                ...
                <div class="stats-grid">
                    <div class="stats-card"><span class="stats-card-label">Total Artwork</span><span class="stats-card-value">{{ $totalArtworks }}</span></div>
                    <div class="stats-card"><span class="stats-card-label">Total Views</span><span class="stats-card-value">{{ $totalViews }}</span></div>
                    <div class="stats-card"><span class="stats-card-label">Total Likes</span><span class="stats-card-value">{{ $totalLikes }}</span></div>
                    <div class="stats-card"><span class="stats-card-label">Total Komentar</span><span class="stats-card-value">{{ $totalComments }}</span></div>
                    <div class="stats-card"><span class="stats-card-label">Total Favorite</span><span class="stats-card-value">{{ $totalFavorites }}</span></div>
                    <div class="stats-card"><span class="stats-card-label">Total Share</span><span class="stats-card-value">{{ $totalShares }}</span></div>
                    <div class="stats-card"><span class="stats-card-label">Total Seniman</span><span class="stats-card-value">{{ $totalArtists }}</span></div>
                    <div class="stats-card"><span class="stats-card-label">Total Pengguna</span><span class="stats-card-value">{{ $totalUsers }}</span></div>
                    <div class="stats-card"><span class="stats-card-label">Total Pengunjung</span><span class="stats-card-value">{{ $totalVisitors }}</span></div>
                    <div class="stats-card"><span class="stats-card-label">Engagement Rate Global</span><span class="stats-card-value">{{ number_format($globalEngagementRate,2) }}%</span></div>
                </div>
            </section>
        ...
        ========================================================== --}}
            ...
            {{-- =========================================================
             TREND HARIAN
        ========================================================== --}}
            <section class="stats-section stats-daily">
                <h2 class="stats-section-title">Tren Harian (30 Hari Terakhir)</h2>
                ...
                <table class="stats-table stats-table-small">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="3">Belum ada data tren harian.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
        ...
        ========================================================== --}}
            ...
            {{-- =========================================================
             TREND TAHUNAN
        ========================================================== --}}
            <section class="stats-section stats-yearly">
                <h2 class="stats-section-title">Tren Tahunan</h2>
                ...
                <table class="stats-table stats-table-small">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="3">Belum ada data tren tahunan.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
        ...
        ========================================================== --}}
            <div class="export-wrapper">
                <a href="{{ route('statistic.export') }}" class="export-btn">
                    Export PDF
                </a>
            </div>
