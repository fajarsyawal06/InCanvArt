...
<head>
    ...
    <!-- CSS khusus registrasi (public) -->
    <link rel="stylesheet" href="{{ asset('css/registrasi.css') }}">

    <!-- JS kamu (tetap, tanpa diubah) -->
            ...
            <form action="{{ route('register.submit') }}" method="POST" class="auth-form">
                ...
                <div class="field">
                    ...
                    <div class="password-wrap">
                        ...
                        <button id="togglePassword2" type="button" aria-label="Tampilkan password" title="Tampilkan password">
                            <!-- Mata terbuka -->
                            <svg id="eyeOpen2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M1 12s4-7 11-7 11 7 11 7-4 7-11 7S1 12 1 12z"></path>
                                <circle cx="12" cy="12" r="3"></circle>
                            </svg>
