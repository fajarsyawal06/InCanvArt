...
<head>
    ...
    {{-- gunakan CSS yang sama dengan halaman tambah kategori --}}
...
<body class="add-category-page">
    ...
    <div class="sm:mt-16">
        <div class="add-cat-wrap">
            ...
            <div class="add-cat-card">
                <form action="{{ route('categories.update', $category->kategori_id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="ac-field-group">
                        ...
                        <textarea
                            ...
                            rows="4"
                            class="ac-textarea"
                            placeholder="Tuliskan deskripsi singkat mengenai kategori ini">{{ old('deskripsi', $category->deskripsi) }}</textarea>
                    </div>
    ...
    {{-- jika pakai flash alert, bisa aktifkan di sini --}}
    {{-- <x-flash></x-flash> --}}
</body>
